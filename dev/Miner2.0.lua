-- Features
-- Lava oder Kohle als Brennstoff Miningmaterial nutzen, zum refuelen
-- Early Game mit Platzieren von Kisten Lategame, Enderchest
-- Fackeln Aktivieren oder Deaktivieren
-- Auf bestimmter Höhe Starten
-- Tunnellänge,abstand zwischen quertunneln und länge,höhe des Tunnels 2 oder 3
-- LavaSaver
-- Configsave beim nächsten Start als standard, rücksetzbar beim Start
-- -
-- -Kohle,Fackeln,Chest Kohle,Chest Fackeln,Chest miningmaterial,Cobble/Nether o.ä
-- -Kohle,Chest Kohle,Chest miningmaterial,Cobble/Nether o.ä
-- -
-- -
-- -
-- links oben Fuel > fackeln > chest fuel > chest fackeln  >CHEST Miningmaterial> cobblestone
tunnelabstand = 1
torchabstand = 1
refuelTorches = true
refuelFuel = true
